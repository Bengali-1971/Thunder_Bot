...
HELP_STRINGS = f"""
*Main Commands :* [Thunder Bot](https://user-images.githubusercontent.com/83629146/119221872-4b7a2180-bb13-11eb-848f-3603d3b89052.jpg)
...
def help_button(update, context):
    ...
    try:
        if mod_match:
            ...
            text = (
                "*âšŠâ®â®â®â® ï½¢  Help  for  {}  module ã€â¯â¯â¯â¯âšŠ*\n".format(
...
def LEGEND_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text= f"\n\n * Hi again! The name is {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by @SAMEER_795.* "
            f"\n\nJoin [SUPPORT GROUP](https://t.me/Thunder_Bot_Support) To Keep Yourself Updated About {dispatcher.bot.first_name}"
